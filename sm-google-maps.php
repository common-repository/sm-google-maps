...
class SMGoogleMaps_Widget extends WP_Widget {
	...
	public function update( $new_instance, $old_instance ) {
	    ...
	    $instance['lat'] 	    = sanitize_mime_type( $new_instance['lat'] );
	    $instance['lng'] 		= sanitize_mime_type( $new_instance['lng'] );
	    $instance['marker'] 	= sanitize_mime_type( $new_instance['marker'] );
	    $instance['mapTypeId'] 	= sanitize_text_field( $new_instance['mapTypeId'] );
